  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
      <div className='flex items-center justify-between'>
        ...
        <Button onClick={isApplied ? null : applyHandler} disabled={isApplied} variant="outline" className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#5f178f] hover:bg-[#5f32ad]'}`}>{isApplied ? 'Already applied' : 'Apply Now'}</Button>
      </div>
...
//         <h1 className='font-bold my-1'>Location: <span className='pl-4 font-normal text-gray-800'>{singleJob?.location}</span></h1>
//         <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>{singleJob?.description}</span></h1>
//         <h1 className='font-bold my-1'>Experience: <span className='pl-4 font-normal text-gray-800'>{singleJob?.experienceLevel
//         } yrs</span></h1>
